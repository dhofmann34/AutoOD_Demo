...
d3.json("http://127.0.0.1:8080/data", function(data) {
    ...
    scatter
        ...
        .on("click", function(d, i) {  // click on data point will highlight
            ...
            if(click_count% 2 == 0){
                ...
                data_tabel1(d.id, d.word_freq_make, d.word_freq_address, d.word_freq_all, d.word_freq_3d, d.word_freq_our, d.word_freq_over, d.word_freq_remove, d.word_freq_internet, d.word_freq_order, d.word_freq_mail)
                ...
                data_tabel2(d.id, d.word_freq_make, d.word_freq_address, d.word_freq_all, d.word_freq_3d, d.word_freq_our, d.word_freq_over, d.word_freq_remove, d.word_freq_internet, d.word_freq_order, d.word_freq_mail)
    ...
    function data_tabel1(id, att1, att2, att3, att4, att5, att6, att7, att8, att9, att10){
        var dataSet = [
            ["id", id],
            ["word_freq_make", att1],
    ...
    function data_tabel2(id, att1, att2, att3, att4, att5, att6, att7, att8, att9, att10){
        var dataSet = [
            ["id", id],
            ["word_freq_make", att1],
            ["word_freq_address", att2],
